        ...
        return (
            t &&
                eachProp(t, function (t, n) {
                    (!i && hasProp(e, n)) ||
                        (!r || "object" != typeof t || !t || isArray(t) || isFunction(t) || t instanceof RegExp ? (e[n] = t) : (e[n] || (e[n] = {}), mixin(e[n], t, i, r)));
                }),
            e
        );
    }
                            ...
                            if (this.error) this.emit("error", this.error);
                                ...
                                if (((this.defining = !0), this.depCount < 1 && !this.defined)) {
                                    if (isFunction(o)) {
                                        ...
                                        if ((this.map.isDefine && void 0 === n && ((t = this.module), t ? (n = t.exports) : this.usingExports && (n = this.exports)), e))
                                            return (
                            ...
                            "string" == typeof i
                                ? isFunction(r)
                                    ...
                                    : ((p = a(i, t, !1, !0)),
                                      ...
                                      hasProp(j, d)
                                          ? j[d]
                                          : c(makeError("notloaded", 'Module name "' + d + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])"))))
                                : (v(),
                                  q.nextTick(function () {
